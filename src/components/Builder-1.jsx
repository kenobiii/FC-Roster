...
function BuilderLayout({
  ...
  const Pitch = (
    <>
      <div ref={exportRef} style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:12, padding:"16px 24px 24px 24px", borderRadius:"1rem", background:"#030712" }}>
        <div style={{ display:"flex", flexDirection:"column", gap:4, alignItems:"center", textAlign:"center", width:"100%" }}>
        ...
        <div style={{ padding:"20px 20px 40px 20px", width:"100%", display:"flex", justifyContent:"center" }}>
          <div ref={pitchRef} className="relative rounded-2xl shadow-2xl"
            ...
            <div style={{ position:"absolute", top:0, left:0, right:0, bottom:0, borderRadius:"1rem", overflow:"hidden" }}><PitchLines/></div>
            {players.map((p,i) => (
            ...
            {showOpposition && oppPlayers.map(p => (
              <div key={p.id} style={{ position:"absolute", display:"flex", flexDirection:"column", alignItems:"center", pointerEvents:"none" }}
            ...
            <svg ref={drawRef} viewBox="0 0 100 100" preserveAspectRatio="none" style={{ position:"absolute", top:0, left:0, width:"100%", height:"100%" }}
      ...
      <p style={{ fontSize:10, textAlign:"center", marginTop:8, width:"100%", color:"#6b7280" }}>
